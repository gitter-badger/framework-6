...
TEST_CASE( "join vector to string", "[string]" )
{
    REQUIRE( String::join( { "Corvusoft", "Solutions" }, ", " ) == "Corvusoft, Solutions" );
}

TEST_CASE( "join vector to string with missing delimiter", "[string]" )
{
    REQUIRE( String::join( { "Corvusoft", "Solutions" }, "" ) == "CorvusoftSolutions" );
}

TEST_CASE( "join vector to string with empty array", "[string]" )
{
    REQUIRE( String::join( { }, "-" ) == "" );
}
